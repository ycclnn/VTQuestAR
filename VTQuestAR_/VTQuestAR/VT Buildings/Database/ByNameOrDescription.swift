...
struct ByNameOrDescription: View {
    ...
    var body: some View {
        ...
        Form {
            Section(header: Text("Enter String contained in a building name or description")) {
                HStack {
            ...
            .navigationBarTitle(Text("Search by Name or Description"), displayMode: .inline)
    ...
    func searchDatabase() {
        ...
        // Building name or description contains queryTrimmed in case insensitive manner
        fetchRequest.predicate = NSPredicate(format: "name CONTAINS[c] %@ OR des_cription CONTAINS[c] %@", queryTrimmed, queryTrimmed)
...
struct ByNameOrDescription_Previews: PreviewProvider {
