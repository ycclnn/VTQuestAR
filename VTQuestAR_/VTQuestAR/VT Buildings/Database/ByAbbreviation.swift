...
struct ByAbbreviation: View {
    ...
    var body: some View {
        ...
        Form {
            Section(header: Text("Enter String contained in a building name abbreviation")) {
                HStack {
            ...
            .navigationBarTitle(Text("Search by Abbreviation"), displayMode: .inline)
    ...
    func searchDatabase() {
        ...
        // Building abbreviation contains queryTrimmed in case insensitive manner
        fetchRequest.predicate = NSPredicate(format: "abbreviation CONTAINS[c] %@", queryTrimmed)
...
struct ByAbbreviation_Previews: PreviewProvider {
