...
struct ByAddress: View {
    ...
    var body: some View {
        ...
        Form {
            Section(header: Text("Enter String contained in a building address")) {
                HStack {
            ...
            .navigationBarTitle(Text("Search by Address"), displayMode: .inline)
    ...
    func searchDatabase() {
        ...
        fetchRequest.predicate = NSPredicate(format: "address CONTAINS[c] %@", queryTrimmed)
...
struct ByAddress_Previews: PreviewProvider {
